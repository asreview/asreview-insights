...
from asreviewcontrib.insights import plot_recall, plot_wss, plot_xxx, plot_recall_xxx
from asreviewcontrib.insights.recall import _plot_recall, _plot_wss, _plot_wss, _plot_recall_xxx
...
def test_plot_wss():
    ...
    with open_state(Path(TEST_ASREVIEW_FILES, "sim_van_de_schoot_2017_1.asreview")) as s:
        ...
        fig.savefig(Path(TEST_FIGURES, "tests_wss_sim_van_de_schoot_2017_1.png"))
